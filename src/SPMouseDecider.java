...
public class SPMouseDecider extends SPSeqDecider
{
	//Concept:
        //        IS: an object that applies this predicate to a sequence record
	//	      'does this SwissProt/TREMBL sequence record represent only	//             one species and is that species mouse'? 
	...
	private static String defaultName = "mouse";
